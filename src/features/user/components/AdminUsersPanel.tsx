...
import { Button, Notice, SelectInput, Surface } from "@/components";
...
export function AdminUsersPanel() {
  ...
  async function patchUser(userId: number, payload: Partial<Pick<AdminUserRead, "role" | "is_active" | "api_access_enabled">>) {
    try {
